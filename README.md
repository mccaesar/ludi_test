...
In the project directory, you need to go to ludi_test folder, server folder, and client folder and run `yarn install`

This ensures that your device is ready to use Create React in your local environment.

Next, go to the server folder and run `yarn start`
