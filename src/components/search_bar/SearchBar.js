...
export default class SearchBar extends Component {
    constructor(props) {
        ...
        if(this.props.searchInfo == null) {
            ...
            this.state = {
                ...
                Description: this.props.searchInfo.searchedFields.includes("Description"),
	...
	render () {
        ...
        var defaultValue = (this.state.searchInfo == null) ? "" : this.state.searchInfo.searchString;
		...
		return (
			<div className="App-search">
                ...
                <Button variant="outlined" color="primary" onClick={this.submitBtOnClick} id="search-button">
                    search
                </Button>
            </div>
		);
