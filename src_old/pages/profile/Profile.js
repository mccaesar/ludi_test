...
export default class Home extends Component {
  ...
  componentDidMount() {
    ...
    if (auth.currentUser == null || auth.currentUser.uid !== this.state.uid) {
      ...
      getSavedResourcesWithUID(this.state.uid, (ids) => {
        this.setState({ resourceIDs: ids });
      });
    }
  }
      ...
      <div id="home">
        <View style={{ flex: 1 }}>
          ...
          <div id="profile-body">
            ...
            <h3>upload</h3>
            <p>
              we welcome feedback and additional resources to be emailed to us
              at ludi@illinois.edu
            </p>
            {saved}
          </div>
          <Footer />
